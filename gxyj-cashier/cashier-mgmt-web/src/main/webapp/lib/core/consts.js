...
define({
     ...
     * @type string
     */
    TOKEN_INFO_URL: 'http://111.204.241.67:8081/uia/',
    //TOKEN_INFO_URL: 'http://10.1.102.218:8081/uia/',
    
    /**
     * **获取用户信息后台接口地址**
     * @type string
     */
    //IMAGE_SERVER_URL: 'http://10.1.102.218/fsshimages/',
    IMAGE_SERVER_URL: 'http://111.204.241.67:81/fsshimages/',
    
    //IMAGE_INFO_URL: 'http://10.1.102.218:8089',
    IMAGE_INFO_URL: 'http://111.204.241.67:8089',
    
    //WEB_BASE_URL: 'http://10.1.102.218:8090',
    WEB_BASE_URL: 'http://111.204.241.67:8090',
     ...
     * @type string
     */
    SESSION_URL: seajs.data.base + "base/session",//'http://192.168.20.32:8080/gxyjfss/'
