...
import com.gxyj.cashier.client.execute.CSRClient;
...
public class TestCRSClient {
	...
	@Test
	public void textCRSClient() {
		String str = "http://10.1.102.167:8989/yqfInterfacePlatform/api/dispatcher";
		RequestParamObjects ifsMessage = new RequestParamObjects();
		ifsMessage.setMsgId("CRS15845555544554545");
		CSRClient cSRClient = new CSRClient(str, "chuyuanjiu", ifsMessage);
		Map map = new HashMap();
		map.put("orderId", "CRS201708180931");
		List list = new ArrayList();
		list.add(map);
		String rtn = cSRClient.execute(list);
